                   ...
                   LLVMValueRef max_value, char *name, bool sign)
{
    ...
    if (!comp_ctx->no_sandbox_mode) {
        ...
        is_less =
            call_fcmp_intrinsic(comp_ctx, func_ctx, FLOAT_LE, LLVMRealOLE,
                                operand, min_value, src_type, "fcmp_min_value");
        ...
        is_greater =
            call_fcmp_intrinsic(comp_ctx, func_ctx, FLOAT_GE, LLVMRealOGE,
                                operand, max_value, src_type, "fcmp_min_value");
                              ...
                              AOTFuncContext *func_ctx)
{
    ...
    res =
        LLVMBuildFPTrunc(comp_ctx->builder, value, F32_TYPE, "f32_demote_f64");
                               ...
                               AOTFuncContext *func_ctx)
{
    ...
    res = LLVMBuildFPExt(comp_ctx->builder, value, F64_TYPE, "f64_promote_f32");
