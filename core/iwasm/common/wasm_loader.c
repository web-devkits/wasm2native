...
static bool
module_is_table64(WASMModule *module, uint32 index)
{
    uint8 table_flag = 0;
    if (module->table_count > 0)
        table_flag = module->tables[index].flags;
    else if (module->import_table_count > 0)
        table_flag = module->import_tables[index].u.table.flags;
                           ...
                           uint32 error_buf_size)
{
    ...
    if (table_segment_count) {
        ...
        for (i = 0; i < table_segment_count; i++, table_segment++) {
            ...
            is_table64 = module_is_table64(module, table_segment->table_index);
    ...
    while (p < p_end) {
        ...
        switch (opcode) {
            ...
            case WASM_OP_RETURN_CALL_INDIRECT:
            {
                ...
                is_table64 = module_is_table64(module, table_idx);
