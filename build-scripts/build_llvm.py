...
def build_llvm(llvm_dir, platform, backends, projects, use_clang=False, extra_flags=''):
    ...
    LLVM_TARGETS_TO_BUILD = [
        ...
        if backends
        else '-DLLVM_TARGETS_TO_BUILD:STRING="AArch64;ARM;Mips;RISCV;WebAssembly;X86"'
    ]
...
def main():
    ...
    parser.add_argument(
        "--platform",
        type=str,
        choices=["android", "darwin", "linux", "windows", "xtensa"],
